...
namespace FinanceMove.Modules.Accounts.Migrations
{
    ...
    [Migration("20260926023717_AccountsCreditLimit")]
    partial class AccountsCreditLimit
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("account", "accounts", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_account_credit_limit", "credit_limit IS NULL OR (\"type\" = 'credit_card' AND credit_limit >= 0)");
                        });
                });
